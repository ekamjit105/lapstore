...
$querya="select * from products where offer='yes' and category = 'laptop'";
$resulta=mysqli_query($con,$querya);
$queryb="select * from products where offer='yes' and category = 'accessory'";
...
<center>
	<h1 class="mhead">Offers and discounts</h1>
</center>
