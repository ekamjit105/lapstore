...
$query="select * from wishlist where uid = '$userid'";
...
<center><h3 class="head">My Wishlist</h3></center>
		...
		<div class="container">
			...
			<div class="col-sm-7">
				<div class="card" >
					...
					<br>
					<center>
					<input type="submit" name="submit" formaction="productdisp.php" value="View product" style="width: 20%;"><br>
					<br><span><input type="submit" name="submit" formaction="cartvalidation.php" value="&#x1f6d2; Add to cart" style="width: 20%;">
					<input type="submit" name="submit" value="&#128465; Remove from Wishlist" style="width: 35%;"></td></span></center>
					<br>
				</div>	
			</div>
			</div>
