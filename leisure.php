...
$querya="select * from products where prof='leisure' and category = 'laptop'";
$resulta=mysqli_query($con,$querya);
$queryb="select * from products where prof='leisure' and category = 'accessory'";
