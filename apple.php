...
$querya="select * from products where brand='apple' and category = 'laptop'";
$resulta=mysqli_query($con,$querya);
$queryb="select * from products where brand='apple' and category = 'accessory'";
...
<img src="logos/apple.png" style="width: 10vw"><br><h1>Apple</h1>
</section>

<img src="home/mac2.jpg" style="width:100vw ;">
</center>
<br>
<div class="container">
	<div class="row" style="background-color: black; padding: 2%; border-radius: 20px 20px;">
		
		<div class="col-sm-5">
			<img src="brandimages/m1.jpg" class="img-fluid">
		</div>
		<div class="col-sm-7" style="color: #CED0D5;">
			<h2>An entire system. <br>On a single chip.</h2><br>
			<p >M1 is here. Our first chip designed specifically for Mac, it delivers incredible performance, custom technologies, and revolutionary power efficiency. And it was designed from the very start to work with the most advanced desktop operating system in the world, macOS Big Sur. With a giant leap in performance per watt, every Mac with M1 is transformed into a completely different class of product. This isn’t an upgrade. It’s a breakthrough.</p>
		</div>
