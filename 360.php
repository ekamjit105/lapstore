...
$querya="select * from products where category = 'laptop' and type='360d'";
$resulta=mysqli_query($con,$querya);
$queryb="select * from products where category = 'laptop' and type='180d'";
...
<center>
	<h1 class="mhead">360&deg; 180 &deg; convertibles</h1>
</center>


<br>
	<h2 class="head">360&deg; Laptops</h2>
<br>
		<div class="container"> 
...
<br>
	<h2  class="head">180&deg; Laptops</h2>
<br>
		<div class="container"> 
