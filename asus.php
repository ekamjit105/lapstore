...
$querya="select * from products where brand='asus' and category = 'laptop'";
$resulta=mysqli_query($con,$querya);
$queryb="select * from products where brand='asus' and category = 'accessory'";
...
<center>
		<section class="whitesec"><h1><img src="logos/ASUS.png" style="width: 10vw;">ASUS </h1></section>
</center>
...
<br>
	<h2 class="head" style="color: black;">Accessories</h2>
<br>
