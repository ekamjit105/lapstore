...
$querya="select * from products where gaming='yes' and category = 'laptop'";
$resulta=mysqli_query($con,$querya);
$queryb="select * from products where gaming='yes' and category = 'accessory'";
$resultb=mysqli_query($con,$queryb);
$queryc="select * from products where gaming='yes' and category = 'accessory' and type = 'upgrade'";
