...
$querya="select * from products where brand='hp' and category = 'laptop'";
$resulta=mysqli_query($con,$querya);
$queryb="select * from products where brand='hp' and category = 'accessory'";
...
<center>
	<section class="whitesec"><h1><img src="logos/hp.png" style="width: 10vw;"></h1></section>
</center>
