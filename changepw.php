...
<hr style="width: 20% background-color:black;">
	...
	<h6>Hi <?php echo $_SESSION['username']; ?>,
	<br>Please reset your password</h6>
	<br>	
	<?php 
	if(isset($_SESSION["pwerr"]))
	{echo '<span style="color:red;">'.$_SESSION['pwerr'].'</span>';
	}
	...
	<br><br>
	<input type="submit" name="submit" value="Change password" id="button" class="loginbtn" style="width: 25%; padding:1%;">
	</form>
	<br>
