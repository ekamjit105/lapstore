...
$querya="select * from products where prof='student' and category = 'laptop'";
$resulta=mysqli_query($con,$querya);
$queryb="select * from products where prof='student' and category = 'accessory'";
