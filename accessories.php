...
$querya="select * from products where type='cover' and category = 'accessory'";
$resulta=mysqli_query($con,$querya);
$queryb="select * from products where type='bag' and category = 'accessory'";
$resultb=mysqli_query($con,$queryb);
$queryc="select * from products where type='headphone' and category = 'accessory'";
$resultc=mysqli_query($con,$queryc);
$queryd="select * from products where type='mouse' and category = 'accessory'";
$resultd=mysqli_query($con,$queryd);
$querye="select * from products where type='webcam' and category = 'accessory'";
...
<center>
	<h1 class="mhead">Accessories and more</h1>
</center>


<br>
	<h2  class="head">Skins and covers</h2>
<br>
		<div class="container"> 
...
<br>
	<h2 class="head">external mouse</h2>
<br>
		<div class="container"> 
