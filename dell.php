...
$querya="select * from products where brand='dell' and category = 'laptop'";
$resulta=mysqli_query($con,$querya);
$queryb="select * from products where brand='dell' and category = 'accessory'";
...
<br>
	...
	<section class="whitesec"><h1><img src="logos/dell.png" style="width: 10vw;"> Yours is Here</h1></section>
