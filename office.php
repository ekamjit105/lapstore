...
$querya="select * from products where prof='office' and category = 'laptop'";
$resulta=mysqli_query($con,$querya);
$queryb="select * from products where prof='office' and category = 'accessory'";
